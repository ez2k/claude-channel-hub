...
Set your Tenor API key in the bot's environment or config:
...
- For sending in Telegram chat, `tinygif` URLs are lighter weight
- GIF URLs can be used directly in markdown: `![alt](url)`
- Use `contentfilter=medium` for Telegram bots in public groups
